...
{
    BOOST_CHECK_EQUAL(to_string(transform(list<int>{0,1,2},[](int x){return x+1;})), /* fill */);
    BOOST_CHECK_EQUAL(transform(optional<int>{1},[](int x){return x+1;}), /* fill */);
    BOOST_CHECK_EQUAL(transform(optional<int>{none},[](int x){return x+1;}), /* fill */);
}
